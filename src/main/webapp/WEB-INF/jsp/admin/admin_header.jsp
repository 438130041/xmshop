    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <c:if test="${admin!=null}">
            <div class="sideMenu am-icon-dashboard" style="color:#aeb2b7; margin: 10px 0 0 0;">
                欢迎系统管理员：${admin.name}<a href="logout">注销</a>
        ...
        <div class="sideMenu">
            ...
            <ul>
                <li><a href="admin_listuser">用户列表</a></li>
            </ul>

            <h3 class="am-icon-users"><em></em> <a href="#">商品管理</a></h3>
            <ul>
                <li><a href="admin_listproduct">商品列表</a></li>
                <li><a href="toCategory">分类管理</a></li>

            </ul>
            <h3 class="am-icon-users"><em></em> <a href="#">轮播管理</a></h3>
            <ul>
                <li><a href="carouselAdmin">轮播展示</a></li>
            ...
            <ul>
                ...
                <li><a href="admin_showAllOrder">全部列表</a></li>

            </ul>
            <h3 class="am-icon-gears"><em></em> <a href="#">统计报表</a></h3>
            <ul>
                <li><a href="go_chart1?cid=1"> 库存统计图 </a></li>
                <li><a href="go_chart2?cid=1"> 销量统计图 </a></li>
                <li><a href="go_chart3?cid=1"> 评论 </a></li>
