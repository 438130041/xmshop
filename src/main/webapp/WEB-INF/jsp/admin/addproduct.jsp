...
<div class="page-container" style="margin-top: 50px">
    <form class="form-horizontal" id="product-add" action="" method="post">
        <div class="form-group">
            <label for="product_name" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>商品名称：
            </label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="product_name"  name="product_name" placeholder="商品名称">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="price" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>价格：
            </label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="price" name="price" placeholder="请输入正确的价格">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <label class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>展示图片上传：
            </label>
            <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    $("#submitBtn").click(function () { //进行表单验证
        ...
        if (bv.isValid()) {
            console.log(images);
            if(images==null){
                layer.alert('请上传商品展示图! ', {title: '错误信息',icon: 0});
                return;
            }
