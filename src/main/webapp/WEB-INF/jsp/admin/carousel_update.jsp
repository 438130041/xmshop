    ...
    <div class="body-content">
        <form action="carousel_update" method="post" class="form-x">
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${carousel.id}" name="id" style="display: none" />
                    <div class="input w50" name="id" >${carousel.id}</div>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${carousel.title}" name="title" />
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="url" value="${carousel.url}"  />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
