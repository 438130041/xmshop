...
<div class="panel admin-panel">
    ...
    <table bgcolor="#ffe4c4" class="table table-hover text-center">
        <tr>
            <th width="10%">图片ID</th>
            <th width="10%">标题</th>
            <th width="20%">图片</th>
        ...
        <c:forEach items="${carouselshow}" var="xm">
            ...
            <td>
                <div class="button-group">
                    <a type="button" class="button border-main" href="tocarousel_update?id=${xm.id}"><span class="icon-edit"></span>修改</a>
