                        ...
                        <ul class="children-list children-list-col children-list-col-1">
                            ...
                            <c:forEach items="${goodsAll}" var="goods">
                                <c:if test="${goods.cid == 1 && a<7}">
                                    ...
                                    <li class="star-goods">
                                        <a class="link" href="details?goodsID=${goods.id}">
                                            <img class="thumb" src="img/goodsInfo/${goods.productimg}" width="40" height="40" alt="">
                                            <span class="text">${goods.product_name}</span></a>
                                        <a class="btn  btn-buy" href="addShoppingCar?goodsID=${goods.id}">选购</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                        </ul>
                ...
                <li class="category-item">
                    ...
                    <div class="children clear children-col" style="display: none;">
                        ...
                        <ul class="children-list children-list-col">
                            <c:set var="a" value="1"></c:set>
                            <c:forEach items="${goodsAll}" var="goods">
                                <c:if test="${goods.cid == 3 || goods.cid == 4 && a<8}">
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="star-goods">
                                        <a class="link" href="details?goodsID=${goods.id}">
                                            <img class="thumb" src="img/goodsInfo/${goods.productimg}" width="40" height="40" alt="">
            ...
            <ul class="main-banner" style="left:0">
                <c:forEach items="${starAll}" var="goods"  begin="0" end="5">
                    <li class="rainbow-item-${a+1}">
                        <c:set var="a" value="${a+1}"></c:set>
                        <a class="thumb" href="details?goodsID=${goods.id}">
                            <img src="img/goodsInfo/${goods.productimg}" alt="${goods.product_name}">
                        </a>
                        <h3> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                        <p class="desc">${goods.price}</p>
                        <p class="price">${goods.price}元起</p>
                    </li>
                </c:forEach>
            </ul>
            ...
            <div class="box-wrapper">
                ...
                <div class="box-rt">
                    <ul class="clear">
                        <c:set var="a" value="1"></c:set>
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:if test="${goods.cid == 8 && a<9}">
                                <c:set var="a" value="${a+1}"></c:set>
                                <li class="box-pro">
                                     <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                    <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                                    <p class="desc">${goods.price}</p>
            ...
            <div class="box-wrapper">
                ...
                <div class="box-rt box-rt-1">
                        ...
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:choose>
                               <%-- <c:when test="${goods.c_ID == 10 || goods.c_ID == 12 && goods.isNew ==1 && a<3 }">&lt;%&ndash;是否是新品&ndash;%&gt;
                                ...
                                <c:when test="${goods.cid == 10 ||goods.cid == 12 }"><%--优惠商品--%>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.productimg}</a></h3>
                                        <p class="desc"></p>
                                        <p class="price">${goods.price}元<%--打折前的价格--%>
                                            <del><span class="num">${goods.price}</span>元</del><%--打折后的价格--%>
                                        </p>
                                        <div class="flag flag-saleoff">享9折</div><%--享受的优惠--%>
                                        <div class="review-wrapper">
                                             <a class="thumb" href="details?goodsID=${goods.price}">
                                                <span class="review">
                    ...
                    <ul class="clear">
                        ...
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:choose>
                                <c:when test="${goods.cid== 10 || goods.cid == 11 }"><%--是否是新品--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                                ...
                                <c:when test="${goods.cid== 10 || goods.cid == 11}"><%--优惠商品--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                                ...
                                <c:when test="${goods.cid == 10 || goods.cid == 11 &&  a<8}">  <%--普通的--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                    ...
                    <ul class="clear">
                        ...
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:choose>
                                ...
                                <c:when test="${goods.cid == 9 &&  a<8}">  <%--普通的--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                    ...
                    <ul class="clear">
                        ...
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:choose>
                                <c:when test="${goods.cid == 13 && a<8 }"><%--是否是新品--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                                ...
                                <c:when test="${goods.cid == 13 &&  a<8}">  <%--普通的--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
            ...
            <div class="box-wrapper">
                ...
                <div class="box-rt box-rt-2">
                    <ul class="clear" style="display: block">
                        ...
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:choose>
                                <c:when test="${goods.cid == 5  && a<8 }"><%--是否是新品--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                    ...
                    <ul class="clear">
                        ...
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:choose>
                                <c:when test="${goods.cid == 14 && a<8 }"><%--是否是新品--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
                    ...
                    <ul class="clear">
                        ...
                        <c:forEach items="${goodsAll}" var="goods">
                            <c:choose>
                                <c:when test="${goods.cid == 6 && a<8 }"><%--是否是新品--%>
                                    <c:set var="a" value="${a+1}"></c:set>
                                    <li class="box-pro">
                                         <a class="thumb" href="details?goodsID=${goods.id}"><img src="img/goodsInfo/${goods.productimg}" alt=""></a>
                                        <h3 class="title"> <a class="thumb" href="details?goodsID=${goods.id}">${goods.product_name}</a></h3>
