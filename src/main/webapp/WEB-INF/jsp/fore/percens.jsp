            ...
            success:function (data) {
                ...
                if(data=="[]"){
                    ...
                    for(var i=0;i<dataObj.length;i++){
                        ...
                        $(".carNulls").next().append("<li><a href='shoppingCar'><img src=\"img/goodsInfo/"+dataObj[i]. productimg+"\" class=\"carImgs\"> <span class=\"carNames\">"+dataObj[i].product_name+"</span> <span class=\"carPrices\">￥"+dataObj[i].price+"</span></a> </li>")
                    }
                }
