			...
			<table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
				...
				<c:forEach items="${o.orderItems}" var="oi" varStatus="st">
					<tr class="orderItemProductInfoPartTR" >
						<td class="orderItemProductInfoPartTD"><img width="80" height="80" src="img/goodsInfo/${oi.product.productimg}"></td>
						<td class="orderItemProductInfoPartTD" align="center">

							<center>
								<div class="orderListItemProductLinkOutDiv">
									<center><br><br>
										<a href="shoppingCar?pid=${oi.product.id}">${oi.product.product_name}</a>
									</center>
								</div>
						...
						<td  class="orderItemProductInfoPartTD" width="100px">
							...
							<div class="orderListItemProductPrice">￥<fmt:formatNumber type="number" value="${oi.product.price}" minFractionDigits="2"/></div>
						</td>
